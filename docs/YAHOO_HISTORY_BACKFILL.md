...
| --- | --- | ---: | ---: | ---: | ---: | ---: | --- |
| 2021 | `406.l.12928` | 10/10 commissioner-supplied Yahoo | Yahoo weekly routes require sign-in | 0 | Image-only / unverified picks | 0 | 10 resolved |
...
- All recovered historical identities resolve; 2021 weekly scoreboards remain unavailable.
